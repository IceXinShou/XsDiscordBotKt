package tw.xserver.plugin.economy.json
...
internal object JsonManager {
    ...
    /**
     * Creates and configures an EmbedBuilder to display a list of user economic data.
     *
     * @param type The type of economic data to display.
     * @param board The list of UserData to display.
     * @return Configured EmbedBuilder.
     */
    fun getEmbedBuilder(
        type: Type,
    ...
    private fun initUserData(user: User) {
        ...
        if (!userData.containsKey(id)) {
            ...
            val obj = json.computeIfAbsent(id.toString(), JsonObject()).getAsJsonObject()
